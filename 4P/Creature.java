...
public class Creature
{
    ...
    // -----------------------------------------------------------------
    /**
     * Mutator to set the location of the Creature.
     * 
     * @param x sets the x coordinate of the creature
     * @param y sets the y coordinate of the creature
     */
    ...
    public Color getColor()
    {
        ...
        return _fishBodyColor;
    }
        
    // -----------------------------------------------------------------
    /**
     * Gets the X location of the Creature object.
     * 
     * @return The X coordinate of Creature object
     */
    public int getXLocation()
    {
        int xLocation = _fishBody.getXLocation();
        return xLocation;
    }
    
    // -----------------------------------------------------------------
    /**
     * Gets the Y location of the Creature object.
     * 
     * @return The Y coordinate of Creature object
     */
    public int getYLocation()
    {
        int yLocation = _topFin.getYLocation();
        return yLocation;
    }
